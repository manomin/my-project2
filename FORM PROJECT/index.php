...
<body>
    ...
    <div class="bg-image d-flex justify-content-center align-items-center" style="background-image: url('banner.jpg'); height: 100vh;">
       
      
      <h1 class="display-2">Hi There,Welcome to GUVI Project</h1>
